  ...
  const fetchCategoryResources = async () => {
    ...
    try {
      ...
      if (activeCategory === "All")
        query = "Financial literacy and money management basics India";
      else if (activeCategory === "Personal Finance")
        query = "Personal Finance basics India budgeting";
      else if (activeCategory === "Tax")
        query = "Income Tax and ITR India guide official";
      else if (activeCategory === "Credit")
        query = "Credit scores CIBIL and loans India guide";
    ...
    <div className="app-container">
      ...
      <header className="hero-header" style={{ paddingBottom: "3rem" }}>
        ...
        <p className="hero-subtitle">
          Master your money with simple, easy-to-understand tutorials on
          essential financial concepts. From taxes to investments, we've got you
          covered.
        </p>
      </header>
        ...
        <div className="section-header">
          ...
          <div>
            ...
            <p className="section-subtitle">
              FILTER TOPICS & RESOURCES BY CATEGORY
            </p>
          </div>
        </div>
        ...
        <section style={{ marginTop: "5rem" }}>
          <div className="section-header" style={{ marginBottom: "2rem" }}>
            ...
            <div>
              ...
              <p className="section-subtitle">
                GENUINE ARTICLES & VIDEOS FOR {activeCategory.toUpperCase()}
              </p>
            </div>
          </div>
                ...
                >
                  {resources.articles && resources.articles.length > 0 ? (
                    ...
                    <p className="text-muted">
                      No expert articles found for this topic yet.
                    </p>
                  )}
                </div>
              )}
              ...
              {loadingResources ? (
                ...
                >
                  {resources.videos && resources.videos.length > 0 ? (
                    ...
                    <p className="text-muted">
                      No tutorial videos found for this topic yet.
                    </p>
                  )}
                </div>
              )}

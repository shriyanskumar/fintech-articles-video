    ...
    <div className="app-container">
      ...
      <header className="hero-header" style={{ paddingBottom: "3rem" }}>
        ...
        <p className="hero-subtitle">
          Quickly access the tutorials and application guides you've bookmarked
          for later.
        </p>
      </header>
      ...
      <main className="main-content">
        ...
        {savedGuides.length === 0 ? (
          <div
            className="info-box"
            style={{ marginTop: "2rem", padding: "3rem", textAlign: "center" }}
          >
            <p
          ...
          <div className="workflow-grid" style={{ marginTop: "2rem" }}>
            {savedGuides.map((guide) => (
              ...
              >
                ...
                <span className="workflow-card-action">Continue Guide →</span>
              </div>
            ))}
          </div>
        )}

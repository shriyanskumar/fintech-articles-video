      ...
      <div className="main-content">
        <div className="info-box danger">
          ...
          <p className="info-box-text">
            This guide doesn't have any steps yet.
          </p>
        </div>
  ...
  return (
    <div className="app-container">
      ...
      <main className="main-content" style={{ maxWidth: "900px" }}>
        {/* Step Content */}
        <section
          className="card step-focused-card"
        ...
        >
          ...
          {currentStep.actionChecklist &&
            currentStep.actionChecklist.length > 0 && (
          ...
          <div className="section-header" style={{ marginBottom: "2rem" }}>
            ...
            <div>
              ...
              <p className="section-subtitle">
                LEARN FROM OFFICIAL SOURCES & EXPERTS
              </p>
            </div>
          </div>
                ...
                >
                  {resources.articles.length > 0 ? (
                    ...
                    <p className="text-muted">
                      No guides found for this workflow yet.
                    </p>
                  )}
                </div>
              )}
              ...
              {loadingResources ? (
                ...
                >
                  {resources.videos.length > 0 ? (
                    ...
                    <p className="text-muted">
                      No video tutorials found for this workflow yet.
                    </p>
                  )}
                </div>
              )}

  ...
  const fetchCategoryResources = async () => {
    ...
    try {
      ...
      if (activeCategory === "All")
        query = "Government Banking financial official guides India";
      else if (activeCategory === "Government")
        query = "Government Documents official guides India";
    ...
    <div className="app-container">
      ...
      <header className="hero-header" style={{ paddingBottom: "3rem" }}>
        ...
        <p className="hero-subtitle">
          Official step-by-step guides for important identity and financial
          applications. Choose a category to filter the services.
        </p>
      </header>
        ...
        <div className="section-header">
          ...
          <div>
            ...
            <p className="section-subtitle">
              FILTER SERVICES & RESOURCES BY TYPE
            </p>
          </div>
        </div>
          ...
          <div className="workflow-grid" style={{ marginTop: "2rem" }}>
            {filteredWorkflows.map((workflow) => (
              ...
              >
                ...
                <span className="workflow-card-action">Start Guide →</span>
              </div>
            ))}
          </div>
        )}
        ...
        <section style={{ marginTop: "5rem" }}>
          <div className="section-header" style={{ marginBottom: "2rem" }}>
            ...
            <div>
              ...
              <p className="section-subtitle">
                GENUINE ARTICLES & TUTORIALS FOR {activeCategory.toUpperCase()}
              </p>
            </div>
          </div>
                  ...
                  {resources.articles && resources.articles.length > 0 ? (
                    resources.articles.map((article, i) => (
                      <a
                        ...
                        className="resource-card article"
                        title={article.url}
                      >
                    ...
                    <p className="text-muted">
                      No official articles found yet. Please try another
                      category.
                    </p>
                  )}
                </div>
              ...
              {loadingResources ? (
                ...
                >
                  {resources.videos && resources.videos.length > 0 ? (
                    ...
                    <p className="text-muted">
                      No tutorial videos found yet. Please try another category.
                    </p>
                  )}
                </div>
              )}
        ...
        <section style={{ marginTop: "4rem" }}>
          <div className="info-box success">
            ...
            <p className="info-box-text">
              We do not collect your personal document data. Our role is to
              explain the process and link you to the official government and
              bank portals where you handle your details safely.
            </p>
          </div>
        </section>
      </main>
